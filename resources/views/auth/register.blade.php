...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="text-align:center;">ユーザー新規登録画面</div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" style="margin:30px 30px;background-color:orange;" class="btn">
                                    新規登録
                                </button>
                                <a class="btn" style="background-color:rgb(40, 183, 235);" href="{{ url("/login") }}">戻る</a>
                            </div>
                        </div>
                    </form>
                </div>
